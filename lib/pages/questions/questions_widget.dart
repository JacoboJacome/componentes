              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (_) => EasyDebounce.debounce(
                        ...
                        () async {
                          setState(() {
                            _model.role = _model.textController.text;
                          });
                        },
                      ),
                      autofocus: true,
                  ...
                  Align(
                    ...
                    child: Builder(
                      builder: (context) {
                        final questions = FFAppState().questions.toList();
                        return Column(
                          mainAxisSize: MainAxisSize.max,
                          children:
                              List.generate(questions.length, (questionsIndex) {
                            final questionsItem = questions[questionsIndex];
                            return Visibility(
                              visible: questionsIndex == _model.index,
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Text(
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      questionsItem.type == 'position'
                                          ? functions.replaceRole(questionsItem,
